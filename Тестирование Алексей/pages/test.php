...
<body>
	...
	<div id="right">
		<p>
			...
			<span>Здесь можно разместить основной текст на странице. Это страница теста.</span><br />
			<span>Чтобы пройти тест нажмите <a href="<?php echo $_SESSION['base_url'];?>/test/start">сюда</a></span><br />
			<span>Чтобы посмотреть результаты прошлого теста нажмите <a href="<?php echo $_SESSION['base_url'];?>/result">сюда</a></span>
		</p>
	</div>
</body>
</html>