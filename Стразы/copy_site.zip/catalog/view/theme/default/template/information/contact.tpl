...
<div class="container">
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <h1><?php //echo $heading_title; ?>НАШИ КОНТАКТЫ</h1>
      ...
      <?php } ?>
<script type="text/javascript" charset="utf-8" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=Gu1lgJNBp6bgGXEk4aPCmJPyp5Ug4mez&width=auto&height=450"></script>
</br>
