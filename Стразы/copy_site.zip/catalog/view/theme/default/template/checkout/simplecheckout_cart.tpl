        ...
        <tr>
            ...
            <td class="name">
                ...
                <?php } ?>
				  <?php if($product['design']){?>
					 <a href="<?php echo $product['design']; ?>"><small>Изменить дизайн продукта</small></a>
				  <?php }?>                
                <div class="options">
            ...
            <td class="quantity">
                <div class="input-group btn-block" style="max-width: 200px;">
                    <input class="form-control" style="width:40px;" type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" />
                    <span class="input-group-btn">
                        ...
                        <button class="btn btn-danger" data-onclick="removeProduct" data-product-key="<?php echo $product['key'] ?>" data-toggle="tooltip" type="button" title="<?php echo $button_remove; ?>">
...
<?php foreach ($totals as $total) { ?>
    <div class="simplecheckout-cart-total" id="total_<?php echo $total['code']; ?>">
        ...
        <span class="simplecheckout-cart-total-remove">
            ...
            <i data-onclick="removeCoupon" title="<?php echo $button_remove; ?>" class="fa fa-times-circle" style="cursor: pointer;"></i>
            <?php } ?>
            <?php if ($total['code'] == 'voucher') { ?>
                <i data-onclick="removeVoucher" title="<?php echo $button_remove; ?>" class="fa fa-times-circle" style="cursor: pointer;"></i>
            <?php } ?>
            <?php if ($total['code'] == 'reward') { ?>
                <i data-onclick="removeReward" title="<?php echo $button_remove; ?>" class="fa fa-times-circle" style="cursor: pointer;"></i>
            <?php } ?>
        </span>
    </div>
<?php } ?>
