<?php if ($error_warning) { ?>
  ...
  <div class="row">
    <div id="content" class="col-sm-12">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="formlogin" class="form-horizontal">
        <fieldset id="account">
        ...
        <?php if ($text_agree) { ?>
        <div class="buttons">
		 <div class="pull-left"><a onclick="createModal('<?php echo $back; ?>');" class="btn btn-primary"><?php echo $button_back; ?></a></div>	
