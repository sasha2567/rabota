...
class ModelCatalogFntClipart extends Model {
	public function addclipart($filter_data) {
	...
	public function getCliparts($filter_data = array()) {
	...
	public function getClipartByCategory($category_clipart_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "fnt_clipart_to_category JOIN  " . DB_PREFIX . "fnt_clipart USING(clipart_id) WHERE category_clipart_id = '" . (int)$category_clipart_id . "' ORDER BY sort_order ASC");
//		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "fnt_clipart_to_category WHERE category_clipart_id = '" . (int)$category_clipart_id . "'");
	...
	public function getTotalcliparts($filter_data = array()) {
