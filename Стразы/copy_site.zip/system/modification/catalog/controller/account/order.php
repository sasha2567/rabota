			...
			if ($order_product_info) {
				...
				if ($product_info) {
					...
					if($product_design_info){
						...
						$this->fnt_cart->addDesign($order_product_info['product_id'], $order_product_info['quantity'], $option_data,0, base64_decode($product_design_info['design']), (float)$price = $product_design_info['price'], $product_design_info['product_design_id'],'');
					} else {
