...
$data['text_fancy_product_designer'] = $this->language->get('text_fancy_product_designer');
				...
				$data['text_fancy_design_ideas'] = $this->language->get('text_fancy_design_ideas');
				$data['text_design_ideas'] = $this->language->get('text_design_ideas');
				$data['text_customer_design_ideas'] = $this->language->get('text_customer_design_ideas');
				$data['text_customer_design_ideas_approved'] = $this->language->get('text_customer_design_ideas_approved');
 ...
 $data['fancy_fonts'] = $this->url->link('catalog/fnt_fonts', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $data['design_ideas'] = $this->url->link('catalog/fnt_product_ideas', 'token=' . $this->session->data['token'], 'SSL');
            $data['customer_design_ideas'] = $this->url->link('catalog/fnt_product_customer_ideas', 'token=' . $this->session->data['token'], 'SSL');
            $data['customer_design_ideas_approved'] = $this->url->link('catalog/fnt_product_customer_ideas_accept', 'token=' . $this->session->data['token'], 'SSL');
