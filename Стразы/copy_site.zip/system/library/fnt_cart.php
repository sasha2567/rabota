...
class FntCart {
	...
	public function addDesign($product_id, $qty = 1, $option = array(), $recurring_id = 0, $fpd_product = '', $price = 0,$product_design_id = 0,$thumbnail = '') {
		...
		if ((int) $qty && ((int) $qty > 0)) {
			if ($validate_cart) {
				...
				$this->session->data['cart-design'][$key_cart]['product_design_id'] = (int)$product_design_id;
			}
		}
	}
