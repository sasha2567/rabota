...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'boardtools.quickreply.listener' => 'getBoardtools_Quickreply_ListenerService',
            'boardtools.quickreply.listener_helper' => 'getBoardtools_Quickreply_ListenerHelperService',
            ...
            'pico.autodbbackup.cron.task.core.auto_db_backup' => 'getPico_Autodbbackup_Cron_Task_Core_AutoDbBackupService',
            ...
            'tatiana5.favicon.listener' => 'getTatiana5_Favicon_ListenerService',
    ...
    /**
     * Gets the 'boardtools.quickreply.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \boardtools\quickreply\event\listener A boardtools\quickreply\event\listener instance.
     */
    protected function getBoardtools_Quickreply_ListenerService()
    {
        return $this->services['boardtools.quickreply.listener'] = new \boardtools\quickreply\event\listener($this->get('auth'), $this->get('config'), $this->get('template'), $this->get('user'), $this->get('dbal.conn'), $this->get('request'), $this->get('content.visibility'), $this->get('boardtools.quickreply.listener_helper'), './', 'php');
    }

    /**
     * Gets the 'boardtools.quickreply.listener_helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \boardtools\quickreply\event\listener_helper A boardtools\quickreply\event\listener_helper instance.
     */
    protected function getBoardtools_Quickreply_ListenerHelperService()
    {
        return $this->services['boardtools.quickreply.listener_helper'] = new \boardtools\quickreply\event\listener_helper($this->get('auth'), $this->get('config'), $this->get('template'), $this->get('user'), $this->get('ext.manager'), $this->get('request'), $this->get('cache'), $this->get('captcha.factory'), $this->get('plupload'), $this->get('mimetype.guesser'), './', 'php');
    }
    ...
    protected function getCron_TaskCollectionService()
    {
        ...
        $instance->add('pico.autodbbackup.cron.task.core.auto_db_backup');
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'root', 'ghjcnjnf', 'forum_base', '', false, false);
    ...
    /**
     * Gets the 'pico.autodbbackup.cron.task.core.auto_db_backup' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pico\autodbbackup\cron\task\auto_db_backup A pico\autodbbackup\cron\task\auto_db_backup instance.
     */
    protected function getPico_Autodbbackup_Cron_Task_Core_AutoDbBackupService()
    {
        $this->services['pico.autodbbackup.cron.task.core.auto_db_backup'] = $instance = new \pico\autodbbackup\cron\task\auto_db_backup('./', 'php', $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), $this->get('log'), $this->get('user'));

        $instance->set_name('pico.autodbbackup.cron.task.auto_db_backup');
    ...
    /**
     * Gets the 'tatiana5.favicon.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \tatiana5\favicon\event\listener A tatiana5\favicon\event\listener instance.
     */
    protected function getTatiana5_Favicon_ListenerService()
    {
        return $this->services['tatiana5.favicon.listener'] = new \tatiana5\favicon\event\listener($this->get('config'), $this->get('template'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'root',
            'dbal.dbpasswd' => 'ghjcnjnf',
            'dbal.dbname' => 'forum_base',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
